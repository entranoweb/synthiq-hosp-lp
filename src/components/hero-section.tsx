    ...
    return (
        <>
            ...
            >
                <div
                    className={
                        "absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgba(22,98,212,0.5)_15%,rgba(0,36,66,0.5)_78%,transparent)]"
                    }
                />
                {/* Planet Logic */}
                <div
                    className={
                        "absolute size-64 md:size-96 bg-[#1662D4] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgba(22,98,212,0.7)_37.7%,rgba(0,24,66))] shadow-[-20px_-20px_50px_rgba(255,255,255,0.5),-20px_-20px_80px_rgba(255,255,255,0.1),0_0_50px_#1662D4]"
                    }
                />
                ...
                <div className={"container relative mt-16"}>
                    <h1
                        className={
                            "text-8xl md:text-[90px] md:leading-none font-semibold bg-white tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgba(22,98,212,0.5))] bg-clip-text text-transparent text-center"
                        }
                    >
